    ...
    ! function(e) {
        ...
        function d(e, t, i, s) {
            for (var n = ["content", "subtext", "tokens"], o = !1, l = 0; l < n.length; l++) {
                var r = n[l],
                    c = e[r];
                if (c && (c = c.toString(), "content" === r && (c = c.replace(/<[^>]+>/g, "")), s && (c = p(c)), c = c.toUpperCase(), o = "contains" === i ? 0 <= c.indexOf(t) : c.startsWith(t))) break
            }
            return o
        }
        ...
        try {
            g.full = (e.fn.dropdown.Constructor.VERSION || "").split(" ")[0].split("."), g.major = g.full[0], g.success = !0
        } catch (t) {
        ...
        "4" === g.major && (b.DIVIDER = "dropdown-divider", b.SHOW = "show", b.BUTTONCLASS = "btn-light", b.POPOVERHEADER = "popover-header");
        var x = new RegExp("38|40"),
            I = new RegExp("^9$|27"),
            k = (new RegExp("13|32"), function(t, i) {
                var s = this;
        ...
        function $(t) {
            var i, s = arguments,
                n = t;
            if ([].shift.apply(s), !g.success) {
                try {
                    g.full = (e.fn.dropdown.Constructor.VERSION || "").split(" ")[0].split(".")
                } catch (t) {
                    g.full = k.BootstrapVersion.split(" ")[0].split(".")
                }
                g.major = g.full[0], g.success = !0, "4" === g.major && (b.DIVIDER = "dropdown-divider", b.SHOW = "show", b.BUTTONCLASS = "btn-light", k.DEFAULTS.style = b.BUTTONCLASS = "btn-light", b.POPOVERHEADER = "popover-header")
            }
        ...
        k.VERSION = "1.13.2", k.BootstrapVersion = g.major, k.DEFAULTS = {
            ...
            virtualScroll: 600,
            display: !1
        }, "4" === g.major && (k.DEFAULTS.style = "btn-light", k.DEFAULTS.iconBase = "", k.DEFAULTS.tickIcon = "bs-ok-default"), k.prototype = {
            constructor: k,
            init: function() {
                var e = this,
                    t = this.$element.attr("id");
                this.$element.addClass("bs-select-hidden"), this.multiple = this.$element.prop("multiple"), this.autofocus = this.$element.prop("autofocus"), this.$newElement = this.createDropdown(), this.createLi(), this.$element.after(this.$newElement).prependTo(this.$newElement), this.$button = this.$newElement.children("button"), this.$menu = this.$newElement.children(w.MENU), this.$menuInner = this.$menu.children(".inner"), this.$searchbox = this.$menu.find("input"), this.$element.removeClass("bs-select-hidden"), !0 === this.options.dropdownAlignRight && this.$menu.addClass(b.MENURIGHT), void 0 !== t && this.$button.attr("data-id", t), this.checkDisabled(), this.clickListener(), this.options.liveSearch && this.liveSearchListener(), this.render(), this.setStyle(), this.setWidth(), this.options.container ? this.selectPosition() : this.$element.on("hide.bs.select", function() {
                    if (e.isVirtual()) {
                        var t = e.$menuInner[0],
            ...
            createDropdown: function() {
                var t = this.multiple || this.options.showTick ? " show-tick" : "",
                    ...
                    s = this.options.header ? '<div class="' + b.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>" : "",
                    ...
                    l = this.multiple && this.options.doneButton ? '<div class="bs-donebutton"><div class="btn-group btn-block"><button type="button" class="btn btn-sm ' + b.BUTTONCLASS + '">' + this.options.doneButtonText + "</button></div></div>" : "",
                    r = '<div class="dropdown bootstrap-select' + t + '"><button type="button" class="' + this.options.styleBase + ' dropdown-toggle" ' + ("static" === this.options.display ? 'data-display="static"' : "") + 'data-toggle="dropdown"' + i + ' role="button"><div class="filter-option"><div class="filter-option-inner"><div class="filter-option-inner-inner"></div></div> </div>' + ("4" === g.major ? "" : '<span class="bs-caret">' + this.options.template.caret + "</span>") + '</button><div class="' + b.MENU + " " + ("4" === g.major ? "" : b.SHOW) + '" role="combobox">' + s + n + o + '<div class="inner ' + b.SHOW + '" role="listbox" aria-expanded="false" tabindex="-1"><ul class="' + b.MENU + " inner " + ("4" === g.major ? b.SHOW : "") + '"></ul></div>' + l + "</div></div>";
                return e(r)
            },
            ...
            createView: function(t, i) {
                ...
                function r(e, i) {
                    ...
                    if (void 0 === b && (b = 0), h = [s.selectpicker.view.position0, s.selectpicker.view.position1], a = Math.max(0, b - 1), d = Math.min(c - 1, b + 1), s.selectpicker.view.position0 = Math.max(0, g[a][0]) || 0, s.selectpicker.view.position1 = Math.min(v, g[d][1]) || 0, p = h[0] !== s.selectpicker.view.position0 || h[1] !== s.selectpicker.view.position1, void 0 !== s.activeIndex && (o = s.selectpicker.current.elements[s.selectpicker.current.map.newIndex[s.prevActiveIndex]], l = s.selectpicker.current.elements[s.selectpicker.current.map.newIndex[s.activeIndex]], n = s.selectpicker.current.elements[s.selectpicker.current.map.newIndex[s.selectedIndex]], i && (s.activeIndex !== s.selectedIndex && (l.classList.remove("active"), l.firstChild && l.firstChild.classList.remove("active")), s.activeIndex = void 0), s.activeIndex && s.activeIndex !== s.selectedIndex && n && n.length && (n.classList.remove("active"), n.firstChild && n.firstChild.classList.remove("active"))), void 0 !== s.prevActiveIndex && s.prevActiveIndex !== s.activeIndex && s.prevActiveIndex !== s.selectedIndex && o && o.length && (o.classList.remove("active"), o.firstChild && o.firstChild.classList.remove("active")), (i || p) && (u = s.selectpicker.view.visibleElements ? s.selectpicker.view.visibleElements.slice() : [], s.selectpicker.view.visibleElements = s.selectpicker.current.elements.slice(s.selectpicker.view.position0, s.selectpicker.view.position1), s.setOptionStatus(), (t || !1 === x && i) && (m = u, f = s.selectpicker.view.visibleElements, w = !(m.length === f.length && m.every(function(e, t) {
                        ...
                        var $, E, S = s.$menuInner[0],
                            y = document.createDocumentFragment(),
                            C = S.firstChild.cloneNode(!1),
                            O = !0 === x ? s.selectpicker.view.visibleElements : s.selectpicker.current.elements;
                        S.replaceChild(C, S.firstChild), I = 0;
                        for (var z = O.length; I < z; I++) y.appendChild(O[I]);
                        !0 === x && ($ = 0 === s.selectpicker.view.position0 ? 0 : s.selectpicker.current.data[s.selectpicker.view.position0 - 1].position, E = s.selectpicker.view.position1 > v - 1 ? 0 : s.selectpicker.current.data[v - 1].position - s.selectpicker.current.data[s.selectpicker.view.position1 - 1].position, S.firstChild.style.marginTop = $ + "px", S.firstChild.style.marginBottom = E + "px"), S.firstChild.appendChild(y)
                    }
            ...
            createLi: function() {
                ...
                var u = function(e, t, i, s) {
                    ...
                    f = function(e, t, i) {
                        ...
                        return e && (11 === e.nodeType ? s.appendChild(e) : s.insertAdjacentHTML("beforeend", e)), void 0 !== t & "" !== t && (s.className = t), "4" === g.major && s.classList.add("dropdown-item"), i && s.setAttribute("style", i), s
                    },
                    v = function(e) {
                ...
                if (this.options.title && !this.multiple) {
                    ...
                    I && (this.selectpicker.view.titleOption.className = "bs-title-option", this.selectpicker.view.titleOption.value = "", x = void 0 === e(w.options[w.selectedIndex]).attr("selected") && void 0 === this.$element.data("selected")), (I || 0 !== this.selectpicker.view.titleOption.index) && w.insertBefore(this.selectpicker.view.titleOption, w.firstChild), x && (w.selectedIndex = 0)
                }
                ...
                k.each(function(h) {
                    ...
                    if (a++, !g.hasClass("bs-title-option")) {
                        var w, x, I = g.data(),
                            ...
                            L = H && D.disabled,
                            N = this.disabled || L,
                            A = this.previousElementSibling && "OPTGROUP" === this.previousElementSibling.tagName,
                            P = T.data();
                        if (!0 === I.hidden || i.options.hideDisabled && (N && !H || L)) w = I.prevHiddenIndex, g.next().data("prevHiddenIndex", void 0 !== w ? w : h), a--, A || void 0 !== w && (F = k[w].previousElementSibling) && "OPTGROUP" === F.tagName && !F.disabled && (A = !0), A && "divider" !== l[l.length - 1].type && (a++, s.push(u(!1, 0, b.DIVIDER, r + "div")), l.push({
                            type: "divider",
                            optID: r
                        }));
                        else {
                            if (H && !0 !== I.divider) {
                                if (i.options.hideDisabled && N) {
                                    if (void 0 === P.allOptionsDisabled) {
                                        var R = T.children();
                                        T.data("allOptionsDisabled", R.filter(":disabled").length === R.length)
                                    }
                                ...
                                if (!this.previousElementSibling) {
                                    ...
                                    var B = D.label,
                                        ...
                                        U = P.subtext,
                                        V = P.icon;
                                    0 !== h && 0 < s.length && (a++, s.push(u(!1, 0, b.DIVIDER, r + "div")), l.push({
                                        type: "divider",
                                        optID: r
                                    })), a++;
                                    var j = function(e) {
                                    ...
                                    s.push(u(j, 0, "dropdown-header" + W, r)), l.push({
                                        content: M,
                                        subtext: U,
                                        type: "optgroup-label",
                                        optID: r
                                ...
                                if (i.options.hideDisabled && N || !0 === I.hidden) return void a--;
                                x = v({
                                    text: y,
                                    optionContent: S,
                                    optionSubtext: O,
                                    optionIcon: z
                                }), s.push(u(f(x, "opt " + $ + W, E), 0, "", r)), l.push({
                                    content: S || y,
                                    subtext: O,
                                    tokens: C,
                                    type: "option",
                            ...
                            } else if (!0 === I.divider) s.push(u(!1, 0, b.DIVIDER)), l.push({
                                type: "divider",
                                originalIndex: h,
                                data: I
                            });
                                ...
                                var F;
                                !A && i.options.hideDisabled && void 0 !== (w = I.prevHiddenIndex) && (F = k[w].previousElementSibling) && "OPTGROUP" === F.tagName && !F.disabled && (A = !0), A && "divider" !== l[l.length - 1].type && (a++, s.push(u(!1, 0, b.DIVIDER, r + "div")), l.push({
                                    type: "divider",
                                    optID: r
                                })), x = v({
                                    text: y,
                            ...
                            G.disabled = N;
                            var _ = 0;
                            G.content && (_ += G.content.length), G.subtext && (_ += G.subtext.length), z && (_ += 1), o < _ && (o = _, t = s[s.length - 1])
                        }
                    }
            ...
            liHeight: function(t) {
                if (t || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var i = document.createElement("div"),
                        ...
                        p = this.options.header && 0 < this.$menu.find("." + b.POPOVERHEADER).length ? this.$menu.find("." + b.POPOVERHEADER)[0].cloneNode(!0) : null,
                        u = this.options.liveSearch ? document.createElement("div") : null,
                        m = this.options.actionsBox && this.multiple && 0 < this.$menu.find(".bs-actionsbox").length ? this.$menu.find(".bs-actionsbox")[0].cloneNode(!0) : null,
                    ...
                    var w, x = a.offsetHeight,
                        ...
                        z = C ? null : e(s),
                        T = {
                            vert: h(C ? C.paddingTop : z.css("paddingTop")) + h(C ? C.paddingBottom : z.css("paddingBottom")) + h(C ? C.borderTopWidth : z.css("borderTopWidth")) + h(C ? C.borderBottomWidth : z.css("borderBottomWidth")),
                            horiz: h(C ? C.paddingLeft : z.css("paddingLeft")) + h(C ? C.paddingRight : z.css("paddingRight")) + h(C ? C.borderLeftWidth : z.css("borderLeftWidth")) + h(C ? C.borderRightWidth : z.css("borderRightWidth"))
                        },
                        D = {
                            vert: T.vert + h(C ? C.marginTop : z.css("marginTop")) + h(C ? C.marginBottom : z.css("marginBottom")) + 2,
                            horiz: T.horiz + h(C ? C.marginLeft : z.css("marginLeft")) + h(C ? C.marginRight : z.css("marginRight")) + 2
                        };
            ...
            selectPosition: function() {
                ...
                var t, i, s, n = this,
                    ...
                    l = function(l) {
                        var r = {},
                            c = n.options.display || e.fn.dropdown.Constructor.Default.display;
                        n.$bsContainer.addClass(l.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(b.DROPUP, l.hasClass(b.DROPUP)), t = l.offset(), o.is("body") ? i = {
                            top: 0,
                            left: 0
                        } : ((i = o.offset()).top += parseInt(o.css("borderTopWidth")) - o.scrollTop(), i.left += parseInt(o.css("borderLeftWidth")) - o.scrollLeft()), s = l.hasClass(b.DROPUP) ? 0 : l[0].offsetHeight, (g.major < 4 || "static" === c) && (r.top = t.top - i.top + s, r.left = t.left - i.left), r.width = l[0].offsetWidth, n.$bsContainer.css(r)
                    };
            ...
            setDisabled: function(e, t, i, s) {
                var n;
                i || (i = this.selectpicker.main.map.newIndex[e]), s || (s = this.selectpicker.main.elements[i]), n = s.firstChild, s.classList.toggle(b.DISABLED, t), n && ("4" === g.major && n.classList.toggle(b.DISABLED, t), n.setAttribute("aria-disabled", t), t ? n.setAttribute("tabindex", -1) : n.setAttribute("tabindex", 0))
            },
            isDisabled: function() {
            ...
            checkDisabled: function() {
                var e = this;
                this.isDisabled() ? (this.$newElement.addClass(b.DISABLED), this.$button.addClass(b.DISABLED).attr("tabindex", -1).attr("aria-disabled", !0)) : (this.$button.hasClass(b.DISABLED) && (this.$newElement.removeClass(b.DISABLED), this.$button.removeClass(b.DISABLED).attr("aria-disabled", !1)), -1 != this.$button.attr("tabindex") || this.$element.data("tabindex") || this.$button.removeAttr("tabindex")), this.$button.click(function() {
                    return !e.isDisabled()
                })
            },
            ...
            clickListener: function() {
                ...
                i.data("spaceSelect", !1), this.$button.on("keyup", function(e) {
                    ...
                    3 < g.major && !t.dropdown && (t.dropdown = t.$button.data("bs.dropdown"), t.dropdown._menu = t.$menu[0])
                }), this.$button.on("click.bs.dropdown.data-api", function() {
                    t.$newElement.hasClass(b.SHOW) || t.setSize()
                }), this.$element.on("shown.bs.select", function() {
                    t.$menuInner[0].scrollTop !== t.selectpicker.view.scrollTop && (t.$menuInner[0].scrollTop = t.selectpicker.view.scrollTop), 3 < g.major ? requestAnimationFrame(n) : s()
                    ...
                    if (t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(), i.preventDefault(), !t.isDisabled() && !n.parent().hasClass(b.DISABLED)) {
                        var p = t.$element.find("option"),
                            ...
                            w = f.data("maxOptions") || !1;
                        if (r === t.activeIndex && (s = !0), s || (t.prevActiveIndex = t.activeIndex, t.activeIndex = void 0), t.multiple) {
                            if (u.prop("selected", !m), t.setSelected(r, !m), n.blur(), !1 !== g || !1 !== w) {
                                var x = g < p.filter(":selected").length,
                                    I = w < f.find("option:selected").length;
                                if (g && x || w && I)
                                    if (g && 1 == g) {
                                        p.prop("selected", !1), u.prop("selected", !0);
                                        for (var k = 0; k < p.length; k++) t.setSelected(k, !1);
                                        t.setSelected(r, !0)
                                    } else if (w && 1 == w) {
                                    for (f.find("option:selected").prop("selected", !1), u.prop("selected", !0), k = 0; k < v.length; k++) {
                                        var $ = v[k];
                                        t.setSelected(p.index($), !1)
                                    }
                                    t.setSelected(r, !0)
                                } else {
                                    var E = "string" == typeof t.options.maxOptionsText ? [t.options.maxOptionsText, t.options.maxOptionsText] : t.options.maxOptionsText,
                                        S = "function" == typeof E ? E(g, w) : E,
                                        y = S[0].replace("{n}", g),
                                        C = S[1].replace("{n}", w),
                                        O = e('<div class="notify"></div>');
                                    S[2] && (y = y.replace("{var}", S[2][1 < g ? 0 : 1]), C = C.replace("{var}", S[2][1 < w ? 0 : 1])), u.prop("selected", !1), t.$menu.append(O), g && x && (O.append(e("<div>" + y + "</div>")), h = !1, t.$element.trigger("maxReached.bs.select")), w && I && (O.append(e("<div>" + C + "</div>")), h = !1, t.$element.trigger("maxReachedGrp.bs.select")), setTimeout(function() {
                                        t.setSelected(r, !1)
                ...
                this.$button.on("click.bs.dropdown.data-api", function() {
                    ...
                    if (e.selectpicker.search.map.newIndex = {}, e.selectpicker.search.map.originalIndex = {}, e.selectpicker.search.elements = [], e.selectpicker.search.data = [], i) {
                        ...
                        for (var a = 0; a < e.selectpicker.main.data.length; a++) {
                            ...
                            o[a] || (o[a] = d(h, n, r, c)), o[a] && void 0 !== h.headerIndex && -1 === l.indexOf(h.headerIndex) && (0 < h.headerIndex && (o[h.headerIndex - 1] = !0, l.push(h.headerIndex - 1)), o[h.headerIndex] = !0, l.push(h.headerIndex), o[h.lastIndex + 1] = !0), o[a] && "optgroup-label" !== h.type && l.push(a)
                        }
                        a = 0;
                        for (var p = l.length; a < p; a++) {
                            ...
                            ("divider" !== h.type || "divider" === h.type && v && "divider" !== v.type && p - 1 !== a) && (e.selectpicker.search.data.push(h), s.push(e.selectpicker.main.elements[u]), h.hasOwnProperty("originalIndex") && (e.selectpicker.search.map.newIndex[h.originalIndex] = s.length - 1, e.selectpicker.search.map.originalIndex[s.length - 1] = h.originalIndex))
                        }
                ...
                if (this.multiple) {
                    ...
                    for (var o = 0; o < this.selectpicker.current.elements.length; o++) {
                        var r = this.selectpicker.current.data[o],
                            a = t[this.selectpicker.current.map.originalIndex[o]];
                        a && !a.disabled && "divider" !== r.type && (a.selected && i++, a.selected = e, a.selected && s++)
                    }
            ...
            keydown: function(t) {
                var i, s, n, o, l, r = e(this),
                    ...
                    a = (c ? r.closest(".dropdown") : r.closest(w.MENU)).data("this"),
                    h = a.findLis(),
                    p = !1,
                    u = 9 === t.which && !c && !a.options.selectOnTab,
                    m = x.test(t.which) || u,
                    f = a.$menuInner[0].scrollTop,
                    g = a.isVirtual(),
                    k = !0 === g ? a.selectpicker.view.position0 : 0;
                if (!(s = a.$newElement.hasClass(b.SHOW)) && (m || 48 <= t.which && t.which <= 57 || 96 <= t.which && t.which <= 105 || 65 <= t.which && t.which <= 90) && a.$button.trigger("click.bs.dropdown.data-api"), 27 === t.which && s && (t.preventDefault(), a.$button.trigger("click.bs.dropdown.data-api").focus()), m) {
                    if (!h.length) return;
                    void 0 === (i = !0 === g ? h.index(h.filter(".active")) : a.selectpicker.current.map.newIndex[a.activeIndex]) && (i = -1), -1 !== i && ((n = a.selectpicker.current.elements[i + k]).classList.remove("active"), n.firstChild && n.firstChild.classList.remove("active")), 38 === t.which ? (-1 !== i && i--, i + k < 0 && (i += h.length), a.selectpicker.view.canHighlight[i + k] || -1 == (i = a.selectpicker.view.canHighlight.slice(0, i + k).lastIndexOf(!0) - k) && (i = h.length - 1)) : (40 === t.which || u) && (++i + k >= a.selectpicker.view.canHighlight.length && (i = 0), a.selectpicker.view.canHighlight[i + k] || (i = i + 1 + a.selectpicker.view.canHighlight.slice(i + k + 1).indexOf(!0))), t.preventDefault();
                    var $ = k + i;
                    38 === t.which ? 0 === k && i === h.length - 1 ? (a.$menuInner[0].scrollTop = a.$menuInner[0].scrollHeight, $ = a.selectpicker.current.elements.length - 1) : p = (l = (o = a.selectpicker.current.data[$]).position - o.height) < f : (40 === t.which || u) && (0 === i ? $ = a.$menuInner[0].scrollTop = 0 : p = f < (l = (o = a.selectpicker.current.data[$]).position - a.sizeInfo.menuInnerHeight)), (n = a.selectpicker.current.elements[$]) && (n.classList.add("active"), n.firstChild && n.firstChild.classList.add("active")), a.activeIndex = a.selectpicker.current.map.originalIndex[$], a.selectpicker.view.currentActive = n, p && (a.$menuInner[0].scrollTop = l), a.options.liveSearch ? a.$searchbox.focus() : r.focus()
                } else if (!r.is("input") && !I.test(t.which) || 32 === t.which && a.selectpicker.keydown.keyHistory) {
                    var E, S, y = [];
                    t.preventDefault(), a.selectpicker.keydown.keyHistory += v[t.which], a.selectpicker.keydown.resetKeyHistory.cancel && clearTimeout(a.selectpicker.keydown.resetKeyHistory.cancel), a.selectpicker.keydown.resetKeyHistory.cancel = a.selectpicker.keydown.resetKeyHistory.start(), S = a.selectpicker.keydown.keyHistory, /^(.)\1+$/.test(S) && (S = S.charAt(0));
                    for (var C = 0; C < a.selectpicker.current.data.length; C++) {
                        var O = a.selectpicker.current.data[C];
                        d(O, S, "startsWith", !0) && a.selectpicker.view.canHighlight[C] && (O.index = C, y.push(O.originalIndex))
                    }
                    if (y.length) {
                        var z = 0;
                        h.removeClass("active").find("a").removeClass("active"), 1 === S.length && (-1 === (z = y.indexOf(a.activeIndex)) || z === y.length - 1 ? z = 0 : z++), E = a.selectpicker.current.map.newIndex[y[z]], 0 < f - (o = a.selectpicker.current.data[E]).position ? (l = o.position - o.height, p = !0) : (l = o.position - a.sizeInfo.menuInnerHeight, p = o.position > f + a.sizeInfo.menuInnerHeight), (n = a.selectpicker.current.elements[E]).classList.add("active"), n.firstChild && n.firstChild.classList.add("active"), a.activeIndex = y[z], n.firstChild.focus(), p && (a.$menuInner[0].scrollTop = l), r.focus()
                    }
                }
                s && (32 === t.which && !a.selectpicker.keydown.keyHistory || 13 === t.which || 9 === t.which && a.options.selectOnTab) && (32 !== t.which && t.preventDefault(), a.options.liveSearch && 32 === t.which || (a.$menuInner.find(".active a").trigger("click", !0), r.focus(), a.options.liveSearch || (t.preventDefault(), e(document).data("spaceSelect", !0))))
            },
            mobile: function() {
