! function(s) {
    ...
    var i, o, n, e = (i = function(t, e) {
        ...
        r = (p.prototype.getDefaults = function() {
            return {}
        }, p.prototype.getResults = function(t, e, s) {
            return this.results
        }, p.prototype.search = function(t, e) {
            e(this.getResults())
        }, e(f, o = p), f.prototype.getDefaults = function() {
            return {
                url: "",
                method: "get",
                queryKey: "q",
        ...
        l = (c.prototype.init = function() {
            ...
            0 < this.items.length ? this.items.forEach(function(t) {
                var e, s = o.formatItem(t);
                "string" == typeof s && (s = {
                    text: s
                }), i = o.showMatchedText(s.text, o.searchText), e = void 0 !== s.html ? s.html : i;
                var i = s.disabled,
                    s = $("<li >");
                s.append($("<a>").attr("href", "#!").html(e)).data("item", t), i && s.addClass("disabled"), n.push(s)
            }) : ((t = $("<li >")).append($("<a>").attr("href", "#!").html(this.noResultsText)).addClass("disabled"), n.push(t)), this._dd.append(n)
        }, c.prototype.itemSelectedLaunchEvent = function(t) {
            this._$el.trigger("autocomplete.select", t)
        }, c),
        a = (u.prototype.getElPos = function() {
            ...
            0 < this.items.length ? (this.items.forEach(function(t) {
                ...
                var i = s.disabled,
                    s = $("<a >");
                s.addClass("dropdown-item").css({
                    overflow: "hidden",
                    "text-overflow": "ellipsis"
                }).html(e).data("item", t), i && s.addClass("disabled"), n.push(s)
            }), this._dd.append(n), this.show()) : "" === this.noResultsText ? this.hide() : ((t = $("<a >")).addClass("dropdown-item disabled").html(this.noResultsText), n.push(t), this._dd.append(n), this.show())
        }, u.prototype.itemSelectedLaunchEvent = function(t) {
            this._$el.trigger("autocomplete.select", t)
        }, u),
        h = (d.prototype.manageInlineDataAttributes = function() {
            ...
            this.bindDefaultEventListeners(), "ajax" === this._settings.resolver && (this.resolver = new r(this._settings.resolverSettings)), 4 === this.getBootstrapVersion()[0] ? this._dd = new a(this._$el, this._settings.formatResult, this._settings.autoSelect, this._settings.noResultsText) : this._dd = new l(this._$el, this._settings.formatResult, this._settings.autoSelect, this._settings.noResultsText)
    ...
    n = jQuery, window, document, n.fn[h.NAME] = function(e, s) {
